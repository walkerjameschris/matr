...
is_in <- function(x, values) {
    .Call(`_matr_is_in`, x, values)
}

get_distances <- function(X, y) {
    .Call(`_matr_get_distances`, X, y)
}

get_k_class <- function(distances, classes, k) {
    .Call(`_matr_get_k_class`, distances, classes, k)
}
